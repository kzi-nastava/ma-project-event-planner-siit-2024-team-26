...
public class UpdateChatDTO {
    ...
    public UpdateChatDTO() {super();}

    public UpdateChatDTO(ChatAuthenticatedUserDTO eventOrganizer, ChatAuthenticatedUserDTO authenticatedUser, boolean user1Blocked, boolean user2Blocked) {
