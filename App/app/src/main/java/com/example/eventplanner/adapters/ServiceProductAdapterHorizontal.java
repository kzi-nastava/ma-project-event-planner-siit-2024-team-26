...
public class ServiceProductAdapterHorizontal extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<ServiceProduct> items;

    public ServiceProductAdapterHorizontal(List<ServiceProduct> items) {
        this.items = items;
    }
